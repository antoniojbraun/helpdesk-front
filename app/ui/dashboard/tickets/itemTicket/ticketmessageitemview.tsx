...
const styleUserMessageEffect =
  "border-b-[#C2CFD9] border-t-transparent border-r-transparent border-l-transparent left-[32px] top-[12px] rotate-45";
...
const styleSupportMessageEffect =
  "border-b-[#1AAE9F] border-t-transparent border-r-transparent border-l-transparent right-[32px] top-[12px] -rotate-45";
...
export default function ItemMessageView({
  ...
  return (
    <div className="relative mb-[20px]" key={messageItem.id}>
      <div
        className={`${colorEfect} absolute border-solid border-[8px] `}></div>
      <div
